...
本文档供 AI 或前端开发者直接生成股票策略网页。运行环境是浏览器，底层数据服务默认为 `127.0.0.1:7899`，不需要 Python 网页服务器，不依赖 ECharts。
...
#js文件从https://a.123128.xyz/docs/*下载
比如gp.js 来自https://a.123128.xyz/docs/gp.js