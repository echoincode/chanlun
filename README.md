...
本项目是一个完整的缠论技术分析系统，提供从数据获取到可视化分析的全流程支持。支持A股、ETF、港股、指数等多市场数据，基于缠论理论实现分型识别、笔段分析等核心功能，并提供多种可视化方案。
...
├── mootdx_data_fetcher.py        # Mootdx数据获取器
